...
$contenu .= '<table class="table">';
    ...
    // affichez un produit par ligne avec dans la colonne "photo" la photos du produit en 90px de large. 
...
while ($produit = $resultat->fetch(PDO::FETCH_ASSOC)) {
    ...
    $contenu .= '<tr>';
        foreach ($produit as $indice => $info) { // cette boucle parcours les informations du tableau $produit
        ...
        $contenu .= '<td>
                    ...
                    </td>'; // nous ajoutons les liens modifier et supprimer sur chaque ligne de produit (nous somme à l'intérieur du <tr>) . Nous passons dans l'URL l'identifiant du produit contenu dans la variable $produit ['id_produit'] (cf debug($produit)).
